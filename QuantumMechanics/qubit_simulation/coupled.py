"""
Contains the class for representing a system of coupled circuits.

Author: Long Nguyen, lbnguyen@lbl.gov
based largely on python code by Konstantin Nesterov
...
class CoupledObjects(object):
    ...
    Unless specified,  work in the basis that is
